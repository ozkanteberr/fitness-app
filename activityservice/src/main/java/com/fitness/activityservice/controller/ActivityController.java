...
public class ActivityController {
    ...
    public ActivityController(IActivityService activityService, AbstractCachingViewResolver abstractCachingViewResolver){
        this.activityService=activityService;
        this.abstractCachingViewResolver = abstractCachingViewResolver;
    }
